...
//	console.log ('name: ', name + '/ course: ', course + ' / month: ', month);
	...
	//or var name = "james", course = "PWA1", month = 3;
...
console.log('------ numbers ----------');
	...
	num1 += num2; //also could be num1 = num1 + num2;
	console.log("+=: ", num1);
	...
	myNum++
	console.log("myNum = ", myNum);//will add 1 to 5
	
	myNum--
	console.log("myNum = ", myNum);//will minus 1 from 6 the new myNum
...
*/
	...
	//string 1 is not equal to number 1 will not output
	if ("1" === 1){
		console.log("'1' === 1, False");

	};
	//makes above statement print
	if ("1" !== 1){
		console.log("'1' == 1, True");
 ...
 */
	...
	if ((1 === 1) && ("hi" === "hi")){
		console.log("&& logical operater: both sides = true");	
	}

    //OR logical operator
	if ((1 === 1) || ("hi" === "no")){
		console.log("|| logical operater: one side = true");
	}

    // ! NOT logical operator
	if (!(1===1) || ("hi" === "no")){
		console.log("! NOT logical operater: left is true converted to NOT");
	}else{
		console.log("! NOT logical operater: both sides = false");
	}
 ...
 ********************************************/
	...
	console.log("nested ternay weahter: ", student1);
 ...
 *****************************/
	...
	var myctr = 1; //global variable because outside function
	
	var myCounter = function() {
		var testVar = 0; //local variable because inside function
		myctr++;
		console.log('counter = ', myctr);
	};
	
	myCounter(); //call to function
	myCounter(); //call a second time (because 1 has been reset to 2 3 will now display)
