...
// 	by using their name as a string - all of the below are valid:
	...
	fsStudent.sayHello(); //dot notation
	//or
	fsStudent['sayHello'](); //index notation
...
// this is integrating multiple data types - object with an array of objects
	...
	console.log(obj1.students[0].GPA);
	console.log(obj1['students'][1]['GPA']);
...
/*
 ...
 //http://www.w3schools.com/jsref/obj_window.asp or dochub.io
 //http://www.w3schools.com/jsref/dom_obj_document.asp 
 //http://www.w3schools.com/jsref/dom_obj_ node.asp 
*/
...
*/
    ...
    */
	...
	console.log(apple);
	console.log(apple.parentNode); //navigate up once
	console.log(apple.parentNode.parentNode); //navigate up twice
...
/*
	...
	------------------------------------------------------------------
        ...
        attr = href, src, class
*/
console.log('------------Manipulating Atrributes setAttribute/getAttribute----------');
...
*/
	...
	bigimage.setAttribute('src', 
		'http://www.instructables.com/files/deriv/FJI/WGSW/FPIUQQ3K/FJIWGSWFPIUQQ3K.MEDIUM.jpg');
...
//				console.log(e);
//				
//				//below goes at end of all click events
//				e.preventDefault();
//				return false;	
//			}
//		}
